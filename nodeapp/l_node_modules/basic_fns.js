    ...
    init_depcy : function(){ // init dependancies
        ...
        if (true){
            ...
            Object.keys(templatePckJsn.dependencies).forEach((v , p)=>{
                ...
                if ( typeof  PckJsn.dependencies[p]=== "undefined"){
                    hasnewPckjsn=true
            ...
            Object.keys(PckJsn.dependencies).forEach((v , p)=>{
                if ( typeof  templatePckJsn.dependencies[p] === "undefined"){
                    hasnewPckjsn=true
            ...
            Object.keys(RtemplatePckJsn.dependencies).forEach((v , p)=>{
                if ( typeof  RPckJsn.dependencies[p] === "undefined"){
                    hasnewPckjsn=true
            ...
            Object.keys(RPckJsn.dependencies ).forEach((v , p)=>{
                if ( typeof  RtemplatePckJsn.dependencies[p] === "undefined"){
                    hasnewPckjsn=true
