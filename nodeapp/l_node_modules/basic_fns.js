    ...
    proc_params_init : function(){
        process.argv.forEach(function (val, index, array) {
            ...
            if (val==="-newaddon" || val==="--newaddon" || val==="-addonnew" || val==="--addonnew" ){
                ...
                if (addonreactjs){
                    execSync("cp -p " + reacttmpl + "/addons/main.js " + reactaddir + ".js" + " || " + "true" )
                        execSync("sed -i \'s/testNewmodue/" + addonname +"/g\' " + reactaddir + ".js"   + " || " + "true" )
                        execSync("sed -i \'s/tAestNewmodue/" + addonname_uppercaseStart +"/g\' " + reactaddir + ".js"    + " || " + "true" )
                    execSync("mkdir -p ../my-app/src/components/custom/" + addonname + " || " + "true" )
                    ...
                    execSync("mkdir -p ../my-app/src/components/custom/" + addonname + "/" + "styles" + " || " + "true" )
                    execSync("mkdir -p ../my-app/src/components/custom/" + addonname + "/" + "extra" + " || " + "true" )
                    execSync("mkdir -p ../my-app/src/components/custom/" + addonname + "/" + "components" + " || " + "true" )
                    execSync("mkdir -p ../my-app/src/components/custom/" + addonname + "/" + "addon_creator_dev_notes" + " || " + "true" )
                    execSync("mkdir -p ../my-app/src/components/custom/" + addonname + "/" + "help" + " || " + "true" )
                }
                if (addonnodejs){
                    ...
                    execSync("cp -p " + "../nodeapp/" + "templates" + "/" + "addons" + "/" + "main" + ".js" + " "+  pckdir + "/" + addonname + ".js"  + " || " + "true"  )                        
                        ...
                        //    .toString()    
                        //)        
                    execSync("cp -p ../nodeapp/templates/addons/vpk.json ../nodeapp/l_node_modules_auto_" + addonname + "/" + addonname + ".vpk"  + " || " + "true"  )
                        execSync("sed -i \'s/testNewmodue/" + addonname +"/g\' ../nodeapp/l_node_modules_auto_" + addonname + "/" + addonname + ".vpk" + " || " + "true" )
                    execSync("mkdir -p ../nodeapp/l_node_modules_auto_" + addonname + "/" + "components"  + " || " + "true" )
                    execSync("mkdir -p ../nodeapp/l_node_modules_auto_" + addonname + "/" + "templates"  + " || " + "true" )
                    execSync("mkdir -p ../nodeapp/l_node_modules_auto_" + addonname + "/" + "scripts" + " || " + "true"  )
                    execSync("mkdir -p ../nodeapp/l_node_modules_auto_" + addonname + "/" + "addon_creator_dev_notes"  + " || " + "true" )
                    execSync("mkdir -p ../nodeapp/l_node_modules_auto_" + addonname + "/" + "package" )
                    execSync("mkdir -p ../nodeapp/l_node_modules_auto_" + addonname + "/" + "help"  + " || " + "true" )
            ...
            if (val==="-buildaddon" || val==="--buildaddon" || val==="-addonbuild" || val==="--addonbuild" ){
                ...
                console.log( "zip -vru " + pckdir + "/" + "package" + "/" + addonname  + ".vpkz" + "\n")
                tmp=execSync("zip -9 -yvru " + pckdir + "/" + "package" + "/" + addonname  + ".vpkz" + " " + pckreact + "/" + addonname + ".js" + " || " + "true"  )
                
                console.log(tmp.toString())
                
                
                tmp=execSync("zip -9 -yvru " + pckdir + "/" + "package" + "/" + addonname  + ".vpkz" + " " + pckreact + "/" + addonname  + " || " + "true"   )
               
                console.log(tmp.toString())

                
                
                tmp=execSync("zip --9 -yvru " + pckdir + "/" + "package" + "/" + addonname  + ".vpkz" + " " + pckdir + "/" + addonname + ".js"  + " || " + "true"  )
                
                console.log(tmp.toString())
                
                
                tmp=execSync("zip -9 -yvru " + pckdir + "/" + "package" + "/" + addonname  + ".vpkz" + " " + pckdir + "/" + addonname + ".vpk"  + " || " + "true"  )
                
                console.log(tmp.toString())
                
               
                tmp=execSync("zip -9 -yvru " + pckdir + "/" + "package" + "/" + addonname  + ".vpkz" + " " + pckdir + "/" + "components" + ""  + " || " + "true" )
                
                console.log(tmp.toString())
                
                
                tmp=execSync("zip -9 -yvru " + pckdir + "/" + "package" + "/" + addonname  + ".vpkz" + " " + pckdir + "/" + "templates" + ""  + " || " + "true" )
                
                console.log(tmp.toString())
                
                tmp=execSync("zip -9 -yvru " + pckdir + "/" + "package" + "/" + addonname  + ".vpkz" + " " + pckdir + "/" + "scripts" + "" + " || " + "true"  )
                
                console.log(tmp.toString())
                
                tmp=execSync("zip -9 -yvru " + pckdir + "/" + "package" + "/" + addonname  + ".vpkz" + " " + pckdir + "/" + "help" + "" + " || " + "true"  )
