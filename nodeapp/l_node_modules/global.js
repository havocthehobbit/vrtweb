let req__debug=false // created this to identify source require modules causing segmentation fault errors without displaying cause 
req__debugI=1

var path = require("path"); 
var fs = require("fs");
if (req__debug){console.log(req__debugI); ++req__debugI ; }
var child_process = require('child_process');
var os = require('os');

if (req__debug){console.log( "!!!!!!!!!!!!!!!!\n" , req__debugI),"\n!!!!!!!!!!!!!!!!" ; ++req__debugI ; }
...
var vrtstd=function(){
    l_this = {
        ...
        */
        ...
        ,main_loop_tree : function( l_obj,l_extra_data, l_cb){ // rt's generic recursion fn
				...
				mongoclient.connect( url , option , function(err, client) {
                    ...
                    if (!_.isNull( err)){
                        if (!_.isUndefined(err)){
                            //assert.equal(null, err); // assert forces faill bassed on response 
